...
@section('title', 'Feed & Supplies Inventory')
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2"><i class="fas fa-grain"></i> Feed & Supplies Inventory</h1>
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                            Total Value</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800" id="total-value">Rs. {{ number_format($totalValue, 2) }}</div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <select class="form-select form-select-lg border-2" id="categoryFilter">
                            ...
                            <option value="hay">Hay & Silage</option>
                            <option value="bedding">Bedding Material</option>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <input type="text" class="form-control form-control-lg border-2 border-start-0 ps-0"
                                   id="itemSearch" placeholder="Item name, supplier...">
                        </div>
                    </div>
                </div>
    ...
    <div class="col-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Feed & Supplies Items</h6>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Feed & Supplies Item</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <form id="addItemForm">
                    @csrf
                    <input type="hidden" name="inventory_type" value="feed_supplies">
                    <div class="row">
...
<script>
    ...
    function loadInventoryItems() {
        ...
        fetch('/api/inventory/all?type=feed_supplies')
    ...
    function applyFilters() {
        ...
        filteredItems = allItems.filter(item => {
            ...
            // Search filter
            const matchesSearch = !searchTerm || itemName.includes(searchTerm) || supplier.includes(searchTerm);
