(function ($) {
  ...
  // Sidebar Toggle - Desktop Collapse (Icon Only Mode) - Desktop Only
  ...
  $(document).ready(function() {
    if ($(window).width() >= 992 && localStorage.getItem("sidebarCollapsed") === "true") {
      $(".sidebar").addClass("collapsed");
      $(".dashboard-main").addClass("collapsed");
      $(".sidebar-toggle").addClass("active");
    }
  });

  // Clear collapsed state on window resize to mobile
  $(window).on('resize', function() {
    if ($(window).width() < 992) {
      $(".sidebar").removeClass("collapsed");
      $(".dashboard-main").removeClass("collapsed");
  ...
  // Mobile Toggle - Mobile Sidebar Open
  ...
  $(".sidebar-overlay, #sidebarOverlay").on("click", function(){
    $(".sidebar").removeClass("sidebar-open");
    $("body").removeClass("overlay-active");
  });
